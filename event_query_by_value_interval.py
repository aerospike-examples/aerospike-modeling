...
optparser.add_option(
    "-s", "--set", dest="set", type="string", default="cdt_demo",
...
messages = {
    '0edf5b73-535c-4be7-b653-c0513dc79fb4': [
        1523474230000, "Billie Jean is not my lover",
        "Michael Jackson", ""],
    '29342a0b-e20f-4676-9ecf-dfdf02ef6683': [
        1523474241001, "She's just a girl who claims that I am the one",
    ...
    '1ae56b18-7a3c-4f64-adb7-2e845eb5094e': [
        1523474257005, "But the kid is not my son",
...
try:
    ...
    v = client.map_get_by_rank_range(
        key, 'messages', -4, 4, aerospike.MAP_RETURN_VALUE)
    pp.pprint(v)
except e.RecordError as e:
    print("Error: {0} [{1}]".format(e.msg, e.code))
